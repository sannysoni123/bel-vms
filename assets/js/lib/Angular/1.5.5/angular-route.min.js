...
(function (C, d) {
    ...
    function z(r, h, g) {
        return{restrict: "ECA", terminal: !0, priority: 400, transclude: "element", link: function (a, c, b, f, y) {
                ...
                var l, m, n, t = b.autoscroll, u = b.onload || "";
        ...
        this.$get = ["$rootScope", "$location", "$routeParams", "$q", "$injector", "$templateRequest",
            "$sce", function (a, c, b, f, h, k, x) {
                ...
                function m() {
                    var v = s.current, e = p;
                    if (w)
                        v.params = e.params, d.copy(v.params, b), a.$broadcast("$routeUpdate", v);
                    else if (e || v)
                        u = !1, (s.current = e) && e.redirectTo && (d.isString(e.redirectTo) ? c.path(t(e.redirectTo, e.params)).search(e.params).replace() : c.url(e.redirectTo(e.pathParams,
                ...
                var u = !1, p, w, s = {routes: g, reload: function () {
                        u = !0;
                        ...
                        if (this.current && this.current.$$route)
                            a = d.extend({}, this.current.params, a), c.path(t(this.current.$$route.originalPath, a)), c.search(a);
                        else
                            throw B("norout");
                    }};
